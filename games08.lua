...
screenGroup:insert(animation2)
	...
	thisLevel = display.newText( "Level 8", 15, 65, native.systemFont, 14)
	thisLevel.alpha =.9
...
function scrollForeground8 (self, event)-- self is really just a place holder for foreground1, foreground2 etc
	if self.x < -650 then
		self.x = 505
...
function scrollBackground8 (self, event)-- self is really just a place holder for foreground1, foreground2 etc
	if self.x < -1000 then
		self.x = 2820
	else self.x = self.x - self.speed
	end
...
if syrupActive then
	...
	if bombActive then 
		...
		background.enterFrame = scrollBackground8
		background2.enterFrame = scrollBackground8
		foreground1.enterFrame =scrollForeground8
		foreground2.enterFrame =scrollForeground8
		foreground3.enterFrame =scrollForeground8
		foreground4.enterFrame =scrollForeground8
		timer.resume(tick)
...
function mollySpeed --change. investigate if this works properly 
	foreground1.enterFrame = scrollForeground82
	Runtime:addEventListener("enterFrame", foreground1)
	foreground2.enterFrame = scrollForeground82
	Runtime:addEventListener("enterFrame", foreground2)
	foreground3.enterFrame = scrollForeground82
	Runtime:addEventListener("enterFrame", foreground3)
	foreground4.enterFrame = scrollForeground82
...
audio.setVolume( .7, { channel=1} )	
	...
	background.enterFrame = scrollBackground8 --change
	Runtime:addEventListener("enterFrame", background)
	background2.enterFrame = scrollBackground8 --change
	Runtime:addEventListener("enterFrame", background2)
	foreground1.enterFrame = scrollForeground8 --enterframe frame  "hey do this (scrollForeground8) thirty times every second
	Runtime:addEventListener("enterFrame", foreground1)
	foreground2.enterFrame = scrollForeground8 
	Runtime:addEventListener("enterFrame", foreground2)
	foreground3.enterFrame = scrollForeground8 
