...
number = number + 1
textCounter.text = number.."/290  Yds"--change
...
screenGroup:insert(animation2)
	...
	thisLevel = display.newText( "Level 9", 15, 65, native.systemFont, 14)
	thisLevel.alpha =.9
...
function scrollForeground9 (self, event)-- self is really just a place holder for foreground1, foreground2 etc
	if self.x < -1040 then
		self.x = 500
...
function scrollBackground9 (self, event)-- self is really just a place holder for foreground1, foreground2 etc
	if self.x < -1000 then
		self.x = 2820
	else self.x = self.x - self.speed
	end
...
if syrupActive then
	...
	if bombActive then 
		...
		background.enterFrame = scrollBackground9
		background2.enterFrame = scrollBackground9
		foreground1.enterFrame =scrollForeground9
		foreground2.enterFrame =scrollForeground9
		foreground3.enterFrame =scrollForeground9
		foreground4.enterFrame =scrollForeground9
		timer.resume(tick)
...
function mollySpeed --change. investigate if this works properly 
	foreground1.enterFrame = scrollForeground92
	Runtime:addEventListener("enterFrame", foreground1)
	foreground2.enterFrame = scrollForeground92
	Runtime:addEventListener("enterFrame", foreground2)
	foreground3.enterFrame = scrollForeground92
	Runtime:addEventListener("enterFrame", foreground3)
	foreground4.enterFrame = scrollForeground92
...
audio.setVolume( .7, { channel=1} )	
	...
	background.enterFrame = scrollBackground9 --change
	Runtime:addEventListener("enterFrame", background)
	background2.enterFrame = scrollBackground9 --change
	Runtime:addEventListener("enterFrame", background2)
	foreground1.enterFrame = scrollForeground9 --enterframe frame  "hey do this (scrollForeground9) thirty times every second
	Runtime:addEventListener("enterFrame", foreground1)
	foreground2.enterFrame = scrollForeground9 
	Runtime:addEventListener("enterFrame", foreground2)
	foreground3.enterFrame = scrollForeground9 
