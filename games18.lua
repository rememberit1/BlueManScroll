...
screenGroup:insert(animation2)
	...
	thisLevel = display.newText( "Level 18", 15, 65, native.systemFont, 14)
	thisLevel.alpha =.9
...
function scrollForeground18 (self, event)-- self is really just a place holder for foreground1, foreground2 etc
	if self.x < -1220 then
		self.x = 1134
...
function scrollBackground18 (self, event)-- self is really just a place holder for foreground1, foreground2 etc
	if self.x < -1030 then
		self.x = 2865
...
if syrupActive then
	...
	if bombActive then 
		...
		background.enterFrame = scrollBackground18
		background2.enterFrame= scrollBackground18
		foreground1.enterFrame =scrollForeground18
		foreground2.enterFrame =scrollForeground18
		foreground3.enterFrame =scrollForeground18
		foreground4.enterFrame =scrollForeground18
		timer.resume(tick)
...
function mollySpeed --change. investigate if this works properly 
	foreground1.enterFrame = scrollForeground182
	Runtime:addEventListener("enterFrame", foreground1)
	foreground2.enterFrame = scrollForeground182
	Runtime:addEventListener("enterFrame", foreground2)
	foreground3.enterFrame = scrollForeground182
	Runtime:addEventListener("enterFrame", foreground3)
	foreground4.enterFrame = scrollForeground182
...
audio.setVolume( .7, { channel=1} )	
	...
	background.enterFrame = scrollBackground18 --change
	Runtime:addEventListener("enterFrame", background)
	background2.enterFrame = scrollBackground18 --change
	Runtime:addEventListener("enterFrame", background2)
	foreground1.enterFrame = scrollForeground18 --enterframe frame  "hey do this (scrollForeground18) thirty times every second
	Runtime:addEventListener("enterFrame", foreground1)
	foreground2.enterFrame = scrollForeground18 
	Runtime:addEventListener("enterFrame", foreground2)
	foreground3.enterFrame = scrollForeground18 
