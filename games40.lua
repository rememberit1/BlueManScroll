...
number = number + 1
textCounter.text = number.."/350  Yds"--change
...
--change the background
	background = display.newImage("background/photoshopProjects/highTech3.png")
	background.xScale = .7
	...
	background2 = display.newImage("background/photoshopProjects/highTech3.png")
	background2.xScale = .7
	background2.yScale = 1.2
	background2.x = 894
	background2.y=210
	background2.speed = .4
	background2.alpha =.4
	screenGroup:insert(background2)
	foreground1 = display.newImage("background/photoshopProjects/highTech2.png")
	foreground1:setReferencePoint(display.BottomLeftReferencePoint)
	foreground1.x= -200
	foreground1.y= 370
	foreground1.xScale = .8
	foreground1.yScale = 1.45
	...
	foreground2 = display.newImage("background/photoshopProjects/highTech2.png")
	foreground2:setReferencePoint(display.BottomLeftReferencePoint)
	foreground2.x= 694
	foreground2.y= 370
	foreground2.xScale = .8
	foreground2.yScale = 1.45
	foreground2.speed = 2
	screenGroup:insert(foreground2)
	foreground3 = display.newImage("background/photoshopProjects/highTech1.png")
	foreground3:setReferencePoint(display.BottomLeftReferencePoint)
	foreground3.x= -200
	foreground3.y= 320
	foreground3.xScale = .7
	foreground3.yScale = 1.7
	foreground3.speed = 8
	screenGroup:insert(foreground3)
	foreground4 = display.newImage("background/photoshopProjects/highTech1.png")
	foreground4:setReferencePoint(display.BottomLeftReferencePoint)
	foreground4.x= 694
	foreground4.y= 320
	foreground4.xScale = .7
	foreground4.yScale = 1.7
	foreground4.speed = 8
...
screenGroup:insert(animation3)
	...
	thisLevel = display.newText( "Level 40", 15, 65, native.systemFont, 14)
	thisLevel.alpha =.9
...
timer.performWithDelay(5100, bacardi, 1)--change
...
function onEnterFrame( event )
	...
	animation2.x = powerupFame.x
	animation2.y = powerupFame.y
...
function scrollForeground40 (self, event)-- self is really just a place holder for foreground1, foreground2 etc
	if self.x < -1040 then
		self.x = 500
...
function scrollBackground40 (self, event)-- self is really just a place holder for foreground1, foreground2 etc
	if self.x < -1000 then
		self.x = 2820
	elseif mollySpeed then 
		self.x = self.x - (self.speed*3)
...
if syrupActive then
	...
	if drunkEngineAttached then 
		...
		background.enterFrame = scrollBackground40
		background2.enterFrame= scrollBackground40
		foreground1.enterFrame =scrollForeground40
		foreground2.enterFrame =scrollForeground40
		foreground3.enterFrame =scrollForeground40
		foreground4.enterFrame =scrollForeground40
		timer.resume(tick)
...
audio.setVolume( .7, { channel=1} )
   ...
   sfx.schoolPlay=audio.play( sfx.school, {channel= 1, onComplete = function()
	...
	background.enterFrame = scrollBackground40 --change
	Runtime:addEventListener("enterFrame", background)
	background2.enterFrame = scrollForeground40 --change
	Runtime:addEventListener("enterFrame", background2)
	foreground1.enterFrame = scrollBackground40 --enterframe frame  "hey do this (scrollForeground) thirty times every second
