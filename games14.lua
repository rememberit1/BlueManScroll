...
audio.setVolume(.5 ,{channel=3})	
	...
	thisLevel = display.newText( "Level 14", 15, 65, native.systemFont, 14)
	thisLevel.alpha =.9
...
function scrollForeground14 (self, event)-- self is really just a place holder for foreground1, foreground2 etc
	if self.x < -650 then
		self.x = 505
...
function scrollBackground14 (self, event)-- self is really just a place holder for foreground1, foreground2 etc
	if self.x < -1000 then
		self.x = 2820
	else self.x = self.x - self.speed
	end
...
if syrupActive then
	...
	if bombActive then 
		...
		background.enterFrame = scrollBackground14
		background2.enterFrame= scrollBackground14
		foreground1.enterFrame =scrollForeground14
		foreground2.enterFrame =scrollForeground14
		foreground3.enterFrame =scrollForeground14
		foreground4.enterFrame =scrollForeground14
		timer.resume(tick)
...
function mollySpeed --change. investigate if this works properly 
	foreground1.enterFrame = scrollForeground142
	Runtime:addEventListener("enterFrame", foreground1)
	foreground2.enterFrame = scrollForeground142
	Runtime:addEventListener("enterFrame", foreground2)
	foreground3.enterFrame = scrollForeground142
	Runtime:addEventListener("enterFrame", foreground3)
	foreground4.enterFrame = scrollForeground142
...
audio.setVolume( .7, { channel=1} )	
	...
	background.enterFrame = scrollBackground14 --change
	Runtime:addEventListener("enterFrame", background)
	background2.enterFrame = scrollBackground14 --change
	Runtime:addEventListener("enterFrame", background2)
	foreground1.enterFrame = scrollForeground14 --enterframe frame  "hey do this (scrollForeground14) thirty times every second
	Runtime:addEventListener("enterFrame", foreground1)
	foreground2.enterFrame = scrollForeground14 
	Runtime:addEventListener("enterFrame", foreground2)
	foreground3.enterFrame = scrollForeground14 
