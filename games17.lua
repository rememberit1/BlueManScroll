...
screenGroup:insert(animation2)
	...
	thisLevel = display.newText( "Level 17", 15, 65, native.systemFont, 14)
	thisLevel.alpha =.9
...
audio.setVolume(.3 ,{channel=4})
audio.setVolume(.3 ,{channel=3})
...
function scrollForeground17 (self, event)-- self is really just a place holder for foreground1, foreground2 etc
	if self.x < -1040 then
		self.x = 500
...
function scrollBackground17 (self, event)-- self is really just a place holder for foreground1, foreground2 etc
	if self.x < -1000 then
		self.x = 2820
	elseif mollySpeed then 
	self.x = self.x - (self.speed*3)
...
if syrupActive then
	...
	if bombActive then 
		...
		background.enterFrame = scrollBackground17
		background2.enterFrame= scrollBackground17
		foreground1.enterFrame =scrollForeground17
		foreground2.enterFrame =scrollForeground17
		foreground3.enterFrame =scrollForeground17
		foreground4.enterFrame =scrollForeground17
		timer.resume(tick)
...
function mollySpeed --change. investigate if this works properly 
	foreground1.enterFrame = scrollForeground172
	Runtime:addEventListener("enterFrame", foreground1)
	foreground2.enterFrame = scrollForeground172
	Runtime:addEventListener("enterFrame", foreground2)
	foreground3.enterFrame = scrollForeground172
	Runtime:addEventListener("enterFrame", foreground3)
	foreground4.enterFrame = scrollForeground172
...
audio.setVolume( 1, { channel=1} )
   ...
   sfx.yeahPlay=audio.play( sfx.yeahRight, {channel= 1, onComplete = function()
	...
	background.enterFrame = scrollBackground17 --change
	Runtime:addEventListener("enterFrame", background)
	background2.enterFrame = scrollBackground17 --change
	Runtime:addEventListener("enterFrame", background2)
	foreground1.enterFrame = scrollForeground17 --enterframe frame  "hey do this (scrollForeground17) thirty times every second
	Runtime:addEventListener("enterFrame", foreground1)
	foreground2.enterFrame = scrollForeground17 
	Runtime:addEventListener("enterFrame", foreground2)
	foreground3.enterFrame = scrollForeground17 
