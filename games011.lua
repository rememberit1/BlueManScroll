...
number = number + 1
textCounter.text = number.."/470  Yds"--change
...
--change the background
	...
	powerupTwerk.x =1600
	powerupTwerk.y = math.random(40, 130)
...
screenGroup:insert(animation2)
	...
	thisLevel = display.newText( "Level 11", 15, 65, native.systemFont, 14)
	thisLevel.alpha =.9
...
function scrollBackground11 (self, event)-- self is really just a place holder for cave1, cave2 etc
	if self.x < -250 then
		self.x = 700
...
function scrollForeground11 (self, event)
if normalSpeed then
	if self.x < -554 then
		self.x = 480
	elseif mollySpeed then 
...
if syrupActive then
	...
	if bombActive then 
		...
		background.enterFrame = scrollBackground11
		background2.enterFrame = scrollBackground11
		foreground1.enterFrame =scrollForeground11
		foreground2.enterFrame =scrollForeground11
		foreground3.enterFrame =scrollForeground11
		foreground4.enterFrame =scrollForeground11
		timer.resume(tick)
...
function mollySpeed --change. investigate if this works properly 
	foreground1.enterFrame = scrollForeground112
	Runtime:addEventListener("enterFrame", foreground1)
	foreground2.enterFrame = scrollForeground112
	Runtime:addEventListener("enterFrame", foreground2)
	foreground3.enterFrame = scrollForeground112
	Runtime:addEventListener("enterFrame", foreground3)
	foreground4.enterFrame = scrollForeground112
...
audio.setVolume( .7, { channel=1} )	
	...
	background.enterFrame = scrollBackground11 --change
	Runtime:addEventListener("enterFrame", background)
	background2.enterFrame = scrollBackground11 --change
	Runtime:addEventListener("enterFrame", background2)
	foreground1.enterFrame = scrollForeground11 --enterframe frame  "hey do this (scrollForeground11) thirty times every second
	Runtime:addEventListener("enterFrame", foreground1)
	foreground2.enterFrame = scrollForeground11 
	Runtime:addEventListener("enterFrame", foreground2)
	foreground3.enterFrame = scrollForeground11 
