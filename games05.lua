...
screenGroup:insert(animation2)
	...
	thisLevel = display.newText( "Level 5", 15, 65, native.systemFont, 14)
	thisLevel.alpha =.9
...
function scrollForeground5 (self, event)-- self is really just a place holder for foreground1, foreground2 etc
	if self.x < -630 then
		self.x = 500
...
function scrollBackground5 (self, event)-- self is really just a place holder for foreground1, foreground2 etc
	if self.x < -1000 then
		self.x = 2820
	else self.x = self.x - self.speed
	end
...
if syrupActive then
	...
	whipTarget.enterFrame = moveWhipCrack
		...
		background.enterFrame = scrollBackground5
		background2.enterFrame = scrollBackground5
		foreground1.enterFrame =scrollForeground5
		foreground2.enterFrame =scrollForeground5
		foreground3.enterFrame =scrollForeground5
		foreground4.enterFrame =scrollForeground5
		timer.resume(tick)
...
function mollySpeed --change. investigate if this works properly 
	foreground1.enterFrame = scrollForeground52
	Runtime:addEventListener("enterFrame", foreground1)
	foreground2.enterFrame = scrollForeground52
	Runtime:addEventListener("enterFrame", foreground2)
	foreground3.enterFrame = scrollForeground52
	Runtime:addEventListener("enterFrame", foreground3)
	foreground4.enterFrame = scrollForeground52
...
audio.setVolume( .7, { channel=1} )	
	...
	background.enterFrame = scrollBackground5 --change
	Runtime:addEventListener("enterFrame", background)
	background2.enterFrame = scrollBackground5 --change
	Runtime:addEventListener("enterFrame", background2)
	foreground1.enterFrame = scrollForeground5 --enterframe frame  "hey do this (scrollForeground5) thirty times every second
	Runtime:addEventListener("enterFrame", foreground1)
	foreground2.enterFrame = scrollForeground5 
	Runtime:addEventListener("enterFrame", foreground2)
	foreground3.enterFrame = scrollForeground5 
